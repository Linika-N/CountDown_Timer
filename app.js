...
days=Math.floor(result/_day)
hours=Math.floor(result%_day/_hour)
minutes=Math.floor(result%_day%_hour/_minute)
seconds=Math.floor(result%_day%_hour%_minute/_second)
